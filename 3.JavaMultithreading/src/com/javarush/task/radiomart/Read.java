...
public class Read {
    ...
    public void readExcel(String filePath, ArrayList<RowExcel> list) throws IOException {
        ...
        while (rowIterator.hasNext()) {
            ...
            RowExcel rowTerminal = new RowExcel();
    ...
    public static void setValueToRowExcel(RowExcel rowExcel, int index, String value) {
        switch (index) {
