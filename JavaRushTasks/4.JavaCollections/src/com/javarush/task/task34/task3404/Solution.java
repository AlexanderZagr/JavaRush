...
public class Solution {
    ...
    public void recursion(final String expression, int countOperation) {
        ...
        String s = withoutSpaces;

        String[] numbers;

        if (withoutSpaces.contains("(") && withoutSpaces.contains(")")) {
            s = withoutSpaces.substring(withoutSpaces.lastIndexOf("(") + 1);
        ...
        if (withoutSpaces.contains("(") && withoutSpaces.contains(")")) {
            String jp = withoutSpaces.replace("(" + s2 + ")", String.valueOf(res));
            recursion(jp, countOperation);
        } else {
